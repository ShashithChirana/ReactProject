...
const Navbar = () => {
  ...
  return (
    ...
    <nav className='bg-blue-100 md:px-14 p-4 max-w-screen-2xl border-b mx-auto text-primary fixed top-0 right-0 left-0 '>
        <div className='text-lg container mx-auto flex justify-between items-center font-medium'>
            ...
            <div className='space-x-12 hidden md:flex items-center'>
                ...
                hover:text-white hover:bg-blue-900'>Sign up</button>
            </div>
